...
// I2C and display definitions
#define I2C_HOST               0
#define DISPLAY_I2C_ADDR       0x3C
#define DISPLAY_WIDTH          128
#define DISPLAY_HEIGHT         64

// Event bits for the buzzer
...
// Static global variable for game state, and team color
...
// Changed to RGBW (4 bytes per LED instead of 3)
...
// Add a static variable to track if we've already done the end-game beep
